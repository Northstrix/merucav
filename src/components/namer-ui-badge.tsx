...
export default function NamerUiBadge({
  ...
  return (
    <a
      ...
      dir={isRTL ? 'rtl' : 'ltr'}
      className="inline-flex flex-col rounded-[12px] select-none"
      style={{
    ...
    >
      <span
        className="text-muted-foreground text-[12px] mb-2"
      ...
      >
        ...
        />
        <span
          className="font-bold text-base text-foreground select-none"
          dir={isRTL ? 'rtl' : 'ltr'}
        >
          {namerUIName}
        </span>
