...
import { IconsEditor } from './icons-editor';
        ...
        <Card>
          ...
          >
            <AccordionItem value="shapes" className="border-b-0">
              <AccordionTrigger className="px-4">{t('shapes')}</AccordionTrigger>
              <AccordionContent>
                <ShapesEditor
                  config={config}
                  setConfig={setConfig}
        ...
        <Card>
          ...
          >
            <AccordionItem value="text" className="border-b-0">
              <AccordionTrigger className="px-4">{t('text')}</AccordionTrigger>
              <AccordionContent>
                <TextEditor
                  config={config}
                  setConfig={setConfig}
        ...
        <Card>
          ...
          >
            <AccordionItem value="icons" className="border-b-0">
              <AccordionTrigger className="px-4">{t('icons')}</AccordionTrigger>
              <AccordionContent>
                <IconsEditor
                  config={config}
                  setConfig={setConfig}
